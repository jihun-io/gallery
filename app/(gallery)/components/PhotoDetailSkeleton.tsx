...
export function SkeletonExifDisplay() {
  return (
    <article className="bg-zinc-900 rounded-lg p-6 space-y-4">
      <section className="flex flex-col justify-between border-b border-zinc-700 pb-3 gap-x-8">
        <div className="h-6 bg-zinc-800 rounded animate-pulse w-20" />
        <div className="h-6 bg-zinc-800 rounded animate-pulse w-32 mt-2" />
      </section>
      <section className="flex flex-col justify-between border-b border-zinc-700 pb-3 gap-x-8">
        <div className="h-6 bg-zinc-800 rounded animate-pulse w-20" />
        <div className="h-6 bg-zinc-800 rounded animate-pulse w-48 mt-2" />
      </section>
